...
task_keyb.add(InlineKeyboardButton('Все задачи', callback_data='u;t;all'))
task_keyb.add(InlineKeyboardButton('Создать новую задачу', callback_data='u;t;new;0r'))
task_keyb.add(InlineKeyboardButton('Меню', callback_data='u;menu'),InlineKeyboardButton('Скачать задачи', callback_data='u;export'))
